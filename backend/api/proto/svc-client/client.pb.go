...
var file_api_proto_svc_client_client_proto_rawDesc = []byte{
	...
	0x22, 0xcf, 0x02, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12,
	...
	0x65, 0x72, 0x22, 0x35, 0x0a, 0x0d, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x49, 0x74,
...
var file_api_proto_svc_client_client_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_proto_svc_client_client_proto_goTypes = []interface{}{
	...
	(*LanguageItems)(nil),          // 5: client.LanguageItems
	(*ResponseStatus)(nil),         // 6: client.ResponseStatus
}
var file_api_proto_svc_client_client_proto_depIdxs = []int32{
	...
	6, // 1: client.GetDataClientResponse.responseStatus:type_name -> client.ResponseStatus
	4, // 2: client.SaveDataClientRequest.dataClient:type_name -> client.DataClient
	6, // 3: client.SaveDataClientResponse.responseStatus:type_name -> client.ResponseStatus
	5, // 4: client.DataClient.languageItems:type_name -> client.LanguageItems
	0, // 5: client.ClientService.GetDataClient:input_type -> client.GetDataClientRequest
	2, // 6: client.ClientService.SaveDataClient:input_type -> client.SaveDataClientRequest
	1, // 7: client.ClientService.GetDataClient:output_type -> client.GetDataClientResponse
	3, // 8: client.ClientService.SaveDataClient:output_type -> client.SaveDataClientResponse
